"""
iResNet architecture for ArcFace face recognition
Based on insightface implementation with correct architecture
"""
...
class IResNet(nn.Module):
    """
    iResNet architecture for ArcFace
    """
    ...
    def __init__(self, block, layers, dropout=0, num_features=512, zero_init_residual=False,
        ...
        # Input layer - changed from 7x7 to 3x3 for face recognition
        ...
        self.features = nn.Linear(512 * block.expansion * 7 * 7, num_features)
        self.bn3 = nn.BatchNorm1d(num_features, eps=1e-05)
...
def iresnet100(pretrained=False, progress=True, **kwargs):
    """
    iResNet-100 for ArcFace
    This is the main model used for face recognition
    """
    return IResNet(IBasicBlock, [3, 13, 30, 3], **kwargs)


def iresnet152(pretrained=False, progress=True, **kwargs):
    return IResNet(IBasicBlock, [3, 8, 36, 3], **kwargs)
