...
export async function seed(knex) {
  ...
  const applications = [
    ...
    // 2/9 - Đi muộn 20 phút (xin lỗi vì ùn tắc)
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-02 18:00:00'),
      updated_at: new Date('2025-09-02 18:00:00')
    },
    ...
    // 4/9 - Về sớm 30 phút (đưa con đi khám bệnh)
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-04 16:00:00'),
      updated_at: new Date('2025-09-04 16:00:00')
    },
    ...
    // 5/9 - Quên check out
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-06 09:00:00'),
      updated_at: new Date('2025-09-06 09:00:00')
    },
    ...
    // 9/9 - Đi muộn 35 phút (xe hỏng)
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-09 17:30:00'),
      updated_at: new Date('2025-09-09 17:30:00')
    },
    ...
    // 10/9 - Quên check in
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-10 17:30:00'),
      updated_at: new Date('2025-09-10 17:30:00')
    },
    ...
    // 11/9 - Làm thêm giờ đến 21:00
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-11 16:00:00'),
      updated_at: new Date('2025-09-11 16:00:00')
    },
    ...
    // 12/9 - Đi muộn 15 phút
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-12 18:00:00'),
      updated_at: new Date('2025-09-12 18:00:00')
    },
    ...
    // 16/9 - Về sớm 45 phút (việc gia đình)
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-16 15:30:00'),
      updated_at: new Date('2025-09-16 15:30:00')
    },
    ...
    // 17/9 - Đi muộn 50 phút (tai nạn giao thông)
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-17 18:00:00'),
      updated_at: new Date('2025-09-17 18:00:00')
    },
    ...
    // 19/9 - Làm thêm giờ đến 20:30
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-19 16:30:00'),
      updated_at: new Date('2025-09-19 16:30:00')
    },
    ...
    // 22/9 - Đi muộn 25 phút
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-22 17:30:00'),
      updated_at: new Date('2025-09-22 17:30:00')
    },
    ...
    // 24/9 - Quên cả check in và check out
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-25 09:00:00'),
      updated_at: new Date('2025-09-25 09:00:00')
    },
    ...
    // 25/9 - Về sớm 1 tiếng (khám sức khỏe định kỳ)
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-25 15:00:00'),
      updated_at: new Date('2025-09-25 15:00:00')
    },
    ...
    // 26/9 - Đi muộn 40 phút
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-26 18:00:00'),
      updated_at: new Date('2025-09-26 18:00:00')
    },
    ...
    // 30/9 - Đi muộn 10 phút
    {
      ...
      approvedBy: null,
      approvedDate: null,
      created_at: new Date('2025-09-30 18:00:00'),
      updated_at: new Date('2025-09-30 18:00:00')
    }
  ];
