export async function seed(knex) {
    ...
    const permissionId = 24;
    const permissionKey = 'attendance_history';
    ...
    if (!existingPerm) {
        await knex('permissions').insert({
            ...
            description: 'Xem lịch sử nhật ký chấm công (Attendance Logs)',
            value: 31,
            key: permissionKey
        });
    ...
    const rolePermissions = [
        ...
        { roleId: 2, permissionId: permissionId, value: 4, scope: 3, key: permissionKey },  // Employee - Personal
    ];
    ...
    console.log('✅ Role permissions for Attendance History assigned.');
};
