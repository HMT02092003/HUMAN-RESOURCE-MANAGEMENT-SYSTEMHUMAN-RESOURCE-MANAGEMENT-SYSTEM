...
const DepartmentEditScreen = ({ route, navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await DepartmentService.updateDepartment(departmentId.toString(), submitData);
  ...
  const handleDelete = () => {
    Alert.alert(
      'Bạn xác nhận xóa phòng ban này?',
      'Phòng ban này sẽ bị xóa vĩnh viễn',
      [
